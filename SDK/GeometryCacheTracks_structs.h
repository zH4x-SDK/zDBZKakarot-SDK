...
struct FMovieSceneGeometryCacheParams
{
	...
	unsigned char                                      UnknownData_N1V8[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TE76[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
