...
struct FLandscapeProxyMaterialOverride
{
	...
	unsigned char                                      UnknownData_GEUL[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightmapLayerAllocationInfo
{
	...
	unsigned char                                      UnknownData_4TLY[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
{
	struct FPerPlatformInt                             LODIndex;                                                  // 0x0000(0x0004) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OTYW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class UMaterialInterface*                          Material;                                                  // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData_E78L[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SNJ4[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FQD3[0x5];                                     // 0x0043(0x0005) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineConnection
{
	...
	unsigned char                                      UnknownData_Z5DR[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineSegmentConnection
{
	...
	unsigned char                                      UnknownData_UZ12[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGrassInput
{
	...
	unsigned char                                      UnknownData_FKN0[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownData_DST1[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            LayerInput;                                                // 0x0010(0x0010) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Q5LB[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FExpressionInput                            HeightInput;                                               // 0x0028(0x0010) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5BFP[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WO7X[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9AGP[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YM5S[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WRFP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5J4L[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XI9C[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2DO6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FLandscapeSplineMeshEntry
{
	...
	unsigned char                                      UnknownData_GGTS[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QMYF[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1EBL[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (PADDING)
