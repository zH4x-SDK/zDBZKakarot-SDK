...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_9JA7[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_2Z2M[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_FC4W[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_UB34[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TL76[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_C0G5[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J9CZ[0x18];                                    // 0x00F0(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q492[0x10];                                    // 0x0590(0x0010) MISSED OFFSET (PADDING)
