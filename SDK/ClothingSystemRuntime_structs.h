...
struct FClothLODData
{
	...
	unsigned char                                      UnknownData_Q1MD[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
struct FClothConfig
{
	...
	unsigned char                                      UnknownData_86E4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4JN0[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothParameterMask_PhysMesh
{
	...
	unsigned char                                      UnknownData_JSSF[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L0IH[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CK2A[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
