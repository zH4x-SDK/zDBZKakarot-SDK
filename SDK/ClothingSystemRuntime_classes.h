...
public:
	...
	unsigned char                                      UnknownData_9Z9T[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_39BG[0x4];                                     // 0x016C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_PNRH[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
