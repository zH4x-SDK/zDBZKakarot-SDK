...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ABNK[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X2AU[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
struct FSocketReference
{
	...
	unsigned char                                      UnknownData_YK8S[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FBoneSocketTarget
{
	...
	unsigned char                                      UnknownData_9MYB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_XQ8R[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I1LY[0x3];                                     // 0x019D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WVI6[0x2];                                     // 0x01BE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6WXM[0x3];                                     // 0x01E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPVL[0x34];                                    // 0x01EC(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_H6S3[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6544[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_AimOffsetLookAt : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_Z708[0x3];                                     // 0x013D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AXOO[0x4];                                     // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D2E6[0x8];                                     // 0x0188(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5R3Z[0x8];                                     // 0x01D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimPhysSphericalLimit
{
	...
	unsigned char                                      UnknownData_JH87[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FBoneReference                              DrivingBone;                                               // 0x0000(0x0018) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GYLZ[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimPhysConstraintSetup
{
	...
	unsigned char                                      UnknownData_4G2T[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3ZO7[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_08W7[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4MJB[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_37BQ[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FJG0[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ZOO[0x1];                                     // 0x0173(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BC4W[0x2];                                     // 0x017E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FE4O[0x3];                                     // 0x01A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8XQ6[0x3];                                     // 0x01B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELOT[0x3];                                     // 0x01B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TY9B[0x2];                                     // 0x01C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TI62[0x7];                                     // 0x0229(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SW1D[0x7];                                     // 0x0241(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BHKA[0x3];                                     // 0x0259(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P2PG[0x134];                                   // 0x026C(0x0134) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	Engine_EAnimAlphaInputType                         AlphaInputType;                                            // 0x0065(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_GYWA[0x1];                                     // 0x0067(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlendBoneByChannelEntry
{
	...
	unsigned char                                      UnknownData_BOE1[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendBoneByChannel : public FAnimNode_Base
{
	...
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBias                             AlphaScaleBias;                                            // 0x0054(0x0008) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I35M[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E172[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CKYG[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_96F0[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5LTI[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FBlendSampleData>                    PerBoneSampleData;                                         // 0x00A0(0x0010) (ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_S8HC[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AZ8Y[0x17];                                    // 0x00C1(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_W15R[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
{
	TArray<int>                                        EnumToPoseIndex;                                           // 0x00D8(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      ActiveEnumValue;                                           // 0x00E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XE6V[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
{
	int                                                ActiveChildIndex;                                          // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3FIH[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_SPGB[0x4];                                     // 0x012C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_I7IQ[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_896N[0x3];                                     // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WJF1[0x7];                                     // 0x0131(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9KV5[0x3];                                     // 0x0159(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9TJW[0x2];                                     // 0x015E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_29ON[0x7];                                     // 0x0161(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_CCDIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_0ATU[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S7QV[0x6];                                     // 0x019A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraint
{
	...
	unsigned char                                      UnknownData_MF7T[0xB];                                     // 0x001D(0x000B) MISSED OFFSET (PADDING)
...
struct FAnimNode_Constraint : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_142I[0x10];                                    // 0x0128(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_S508[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_PM4Z[0xAE];                                    // 0x003A(0x00AE) MISSED OFFSET (PADDING)
...
struct FAnimNode_CurveSource : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_B4AT[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_62KX[0x7];                                     // 0x0121(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_513Q[0x7];                                     // 0x01A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZYCA[0xF];                                     // 0x01E1(0x000F) MISSED OFFSET (PADDING)
...
struct FAnimNode_HandIKRetargeting : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_KI0P[0x4];                                     // 0x0164(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_9RG9[0x30];                                    // 0x00A8(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UFGW[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
struct FAnimLegIKDefinition
{
	...
	unsigned char                                      UnknownData_SQFD[0x1];                                     // 0x0037(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WX3C[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_LegIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_WA4I[0x8];                                     // 0x0118(0x0008) MISSED OFFSET (PADDING)
...
struct FIKChain
{
	unsigned char                                      UnknownData_0JM3[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
struct FIKChainLink
{
	unsigned char                                      UnknownData_F7KL[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
struct FAnimNode_MakeDynamicAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_956M[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_4VRJ[0x6];                                     // 0x0132(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyCurve : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_S8NW[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PXZ8[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_JFNK[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FInputScaleBias                             AlphaScaleBias;                                            // 0x0054(0x0008) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XTIK[0x14];                                    // 0x005C(0x0014) MISSED OFFSET (PADDING)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_2MRV[0x2];                                     // 0x010A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_F476[0x30];                                    // 0x0060(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_1OD4[0x7];                                     // 0x00A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_E5GA[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FRBFParams
{
	...
	unsigned char                                      UnknownData_TUZ1[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPoseDriverTarget
{
	...
	unsigned char                                      UnknownData_6ZOR[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HLC9[0x8];                                     // 0x00A0(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_MV1P[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D5EY[0x6];                                     // 0x00F2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U44N[0x2];                                     // 0x0122(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9M0D[0x38];                                    // 0x0128(0x0038) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseSnapshot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_3QNC[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_27TF[0x38];                                    // 0x0078(0x0038) MISSED OFFSET (PADDING)
...
struct FRandomPlayerSequenceEntry
{
	...
	unsigned char                                      UnknownData_5XVG[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_IRUD[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SL6D[0x48];                                    // 0x0048(0x0048) MISSED OFFSET (PADDING)
...
struct FAnimNode_RefPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_7ZM6[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XMCK[0x10];                                    // 0x00F0(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_WZU2[0x2];                                     // 0x0136(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A3PJ[0x3];                                     // 0x0136(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_IAAR[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_82GO[0x3];                                     // 0x0159(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CHGV[0x40D];                                   // 0x0163(0x040D) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_QDSB[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_PD0X[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_FL2E[0x2];                                     // 0x013E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S8G1[0x7];                                     // 0x0151(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_VD1J[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MKYN[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N43H[0x17];                                    // 0x0099(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_GCXA[0x2];                                     // 0x0066(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YQDJ[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_Slot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_C82P[0x1F];                                    // 0x0049(0x001F) MISSED OFFSET (PADDING)
...
struct FSplineIKCachedBoneData
{
	...
	unsigned char                                      UnknownData_T627[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_KIW1[0x2];                                     // 0x0122(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_43DK[0x4];                                     // 0x0144(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WLGL[0x70];                                    // 0x0188(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CY6K[0x4];                                     // 0x025C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_EDOW[0x3];                                     // 0x0109(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GO7J[0x35];                                    // 0x0123(0x0035) MISSED OFFSET (PADDING)
...
struct FAnimNode_Trail : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_32ZR[0x2];                                     // 0x010E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_49ZS[0x64];                                    // 0x021C(0x0064) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwistCorrectiveNode : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_Y8H9[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FAnimCurveParam                             Curve;                                                     // 0x0160(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KJES[0x8];                                     // 0x0170(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_K49A[0x3];                                     // 0x0109(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IM2A[0x3];                                     // 0x011D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2UV4[0x7];                                     // 0x0121(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C53N[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBoneSocketTarget                           EffectorTarget;                                            // 0x0140(0x0060) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_TWVG[0x3];                                     // 0x01A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YPUA[0x8];                                     // 0x01B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VFKC[0x3];                                     // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P27R[0xB];                                     // 0x0235(0x000B) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_P09S[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TAX5[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FInputAlphaBoolBlend                        AlphaBoolBlend;                                            // 0x0068(0x0050) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FName                                       AlphaCurveName;                                            // 0x00B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                       // 0x00C0(0x0030) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_W4V4[0x1];                                     // 0x00F7(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ND89[0x220];                                   // 0x0590(0x0220) MISSED OFFSET (PADDING)
...
struct FRBFTarget : public FRBFEntry
{
	...
	unsigned char                                      UnknownData_0QYH[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
