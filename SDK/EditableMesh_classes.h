...
// 0x05F8 (FullSize[0x0620] - InheritedSize[0x0028])
class UEditableMesh : public UObject
{
public:
	unsigned char                                      UnknownData_8CIS[0x300];                                   // 0x0028(0x0300) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x0328(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	int                                                TextureCoordinateCount;                                    // 0x0338(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V5JQ[0xF8];                                    // 0x033C(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                PendingCompactCounter;                                     // 0x0434(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int                                                SubdivisionCount;                                          // 0x0438(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JIHG[0x1E4];                                   // 0x043C(0x01E4) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WR4P[0xA4];                                    // 0x003C(0x00A4) MISSED OFFSET (PADDING)
