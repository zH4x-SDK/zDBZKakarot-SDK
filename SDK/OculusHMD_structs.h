...
struct FGuardianTestResult
{
	...
	unsigned char                                      UnknownData_Z8I7[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHmdUserProfile
{
	...
	unsigned char                                      UnknownData_G5E7[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOculusSplashDesc
{
	...
	unsigned char                                      UnknownData_52W8[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BYR0[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CO9B[0x1F];                                    // 0x0081(0x001F) MISSED OFFSET (PADDING)
