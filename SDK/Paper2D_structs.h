...
struct FPaperFlipbookKeyFrame
{
	...
	unsigned char                                      UnknownData_AOIF[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperSpriteSocket
{
	...
	unsigned char                                      UnknownData_FQOW[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FPaperTerrainMaterialRule
{
	...
	unsigned char                                      UnknownData_E08C[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JWX9[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileInfo
{
	...
	unsigned char                                      UnknownData_7T2A[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileSetTerrain
{
	...
	unsigned char                                      UnknownData_NZEU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSpriteGeometryShape
{
	...
	unsigned char                                      UnknownData_PX6O[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N6M6[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FSpriteGeometryCollection
{
	...
	unsigned char                                      UnknownData_122R[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TY3X[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7HHB[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperTileMetadata
{
	...
	unsigned char                                      UnknownData_B6JI[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPaperSpriteAtlasSlot
{
	...
	unsigned char                                      UnknownData_FJRZ[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FSpriteDrawCallRecord
{
	...
	unsigned char                                      UnknownData_5QWN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H005[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B6MR[0x84];                                    // 0x004C(0x0084) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XE4O[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
