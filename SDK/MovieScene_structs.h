...
struct FMovieSceneTrackEvalOptions
{
	...
	unsigned char                                      UnknownData_L9O6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      UnknownData_HRU5[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ROBP[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Y4JX[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UEXI[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FJDQ[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LTLC[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WJBS[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EFHM[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CZI9[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2ZIR[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneTemplateGenerationLedger
{
	...
	unsigned char                                      UnknownData_HYZD[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequenceHierarchyNode
{
	...
	unsigned char                                      UnknownData_MN7P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSubSequenceData
{
	...
	unsigned char                                      UnknownData_J8PC[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneSequenceInstanceDataPtr          InstanceData;                                              // 0x0068(0x0018) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CZVA[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XE2N[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData_JGPR[0x5];                                     // 0x0013(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DYQH[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTemplate
{
	...
	unsigned char                                      UnknownData_VU2U[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FEFP[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      UnknownData_LIOG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RGB4[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JSPN[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectBindingID
{
	...
	unsigned char                                      UnknownData_73D7[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_MMGY[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R9EI[0x298];                                   // 0x0068(0x0298) MISSED OFFSET (PADDING)
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      UnknownData_SMFA[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LRID[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      UnknownData_7MCX[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VPVS[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
	...
	unsigned char                                      UnknownData_KN6U[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_B5UY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneTangentData
{
	...
	unsigned char                                      UnknownData_J9EQ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValue
{
	...
	unsigned char                                      UnknownData_HCM3[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_Q7I3[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DVYB[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_5XXE[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<bool>                                       Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_5EYG[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	...
	bool                                               bHasDefaultValue;                                          // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_KEPP[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0PM9[0x60];                                    // 0x0038(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S0HW[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSectionData
{
	...
	unsigned char                                      UnknownData_HSVD[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_3XS8[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        Values;                                                    // 0x0020(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_FIKJ[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PAOL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneKeyTimeStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_6JX2[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
struct FSectionEvaluationData
{
	...
	unsigned char                                      UnknownData_BG1X[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0115[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
