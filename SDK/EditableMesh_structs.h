...
{
	unsigned char                                      UnknownData_P1ZN[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FSubdividedWireEdge
{
	...
	unsigned char                                      UnknownData_XHK9[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PO0P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshElementAttributeData
{
	...
	unsigned char                                      UnknownData_DZTM[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEdgeToCreate
{
	...
	unsigned char                                      UnknownData_0D5P[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPolygonGroupToCreate
{
	...
	unsigned char                                      UnknownData_TXWF[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FPolygonToCreate
{
	...
	unsigned char                                      UnknownData_92TM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	EditableMesh_EPolygonEdgeHardness                  PolygonEdgeHardness;                                       // 0x002C(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4XFA[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FVertexInstanceToCreate
{
	...
	unsigned char                                      UnknownData_AXBA[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YEU6[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FVertexToCreate
{
	...
	unsigned char                                      UnknownData_VWDM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FAttributesForEdge
{
	...
	unsigned char                                      UnknownData_OQD2[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZXOT[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FVertexInstanceID                           VertexInstanceID;                                          // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_A45P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMeshElementAttributeList                   VertexInstanceAttributes;                                  // 0x0008(0x0010) (BlueprintVisible, NativeAccessSpecifierPublic)
...
{
	struct FVertexID                                   VertexID;                                                  // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QDV0[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FPolygonID                                  PolygonID;                                                 // 0x0000(0x0004) (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LRIA[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRenderingPolygonGroup
{
	...
	unsigned char                                      UnknownData_841B[0x3C];                                    // 0x000C(0x003C) MISSED OFFSET (PADDING)
...
struct FRenderingPolygon
{
	...
	unsigned char                                      UnknownData_10B6[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
