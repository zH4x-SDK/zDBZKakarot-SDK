...
{
	unsigned char                                      UnknownData_SD3L[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_HT0T[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_J2E9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_N5XJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7RE7[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
