...
struct FSubmixEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_8F1E[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B716[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FSubmixEffectEQBand
{
	...
	unsigned char                                      UnknownData_MSYT[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
