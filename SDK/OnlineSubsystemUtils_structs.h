...
{
	unsigned char                                      UnknownData_L2AW[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_2L28[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_KHBQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
