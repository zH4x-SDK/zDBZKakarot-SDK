...
struct FCameraLookatTrackingSettings
{
	...
	unsigned char                                      UnknownData_CHNR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1SQB[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BJDO[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FNamedFilmbackPreset
{
	...
	unsigned char                                      UnknownData_QUSB[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCameraTrackingFocusSettings
{
	...
	unsigned char                                      UnknownData_MNWY[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraFocusSettings
{
	...
	unsigned char                                      UnknownData_EW2V[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NXPK[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3MSH[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PNXB[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
