...
struct FMovieSceneCaptureSettings
{
	...
	unsigned char                                      UnknownData_RUKI[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FBMW[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KXO8[0x5];                                     // 0x004B(0x0005) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZXK3[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
