...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData_KFC5[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T7PS[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      UnknownData_EMPL : 1;                                      // 0x0040(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_845Z[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FActorPerceptionBlueprintInfo
{
	...
	unsigned char                                      UnknownData_REAX[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FAIDamageEvent
{
	...
	unsigned char                                      UnknownData_DUZL[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7XBU[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VYZ2[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIPredictionEvent
{
	...
	unsigned char                                      UnknownData_Z1QE[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2YKX[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0RKE[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAISenseAffiliationFilter
{
	...
	unsigned char                                      UnknownData_380B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FAIMoveRequest
{
	...
	unsigned char                                      UnknownData_PBY7[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FBTDecoratorLogic
{
	...
	unsigned char                                      UnknownData_OT9X[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBehaviorTreeTemplateInfo
{
	...
	unsigned char                                      UnknownData_SN7T[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FBlackboardEntry
{
	...
	unsigned char                                      UnknownData_1ZJQ[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FBlackboardKeySelector
{
	...
	unsigned char                                      UnknownData_0MGO[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3K7A[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PRQY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIDataProviderFloatValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_58E7[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDynamicParam
{
	...
	unsigned char                                      UnknownData_QD8K[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	unsigned char                                      UnknownData_4CQ2[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6MKS[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
struct FEnvNamedValue
{
	...
	unsigned char                                      UnknownData_GMPJ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Value;                                                     // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FAIDataProviderBoolValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_B330[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvTraceData
{
	...
	unsigned char                                      UnknownData_FFOV[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BNLK[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDataProviderIntValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_8C6G[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FEnvDirection
{
	...
	unsigned char                                      UnknownData_FR1F[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData_REPA[0x170];                                   // 0x0008(0x0170) MISSED OFFSET (PADDING)
...
struct FEnvOverlapData
{
	...
	unsigned char                                      UnknownData_G5DX[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YBC8[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FPawnActionEvent
{
	...
	unsigned char                                      UnknownData_J4OX[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J5FR[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YAIU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnvQueryRequest
{
	...
	unsigned char                                      UnknownData_ZZ8S[0x50];                                    // 0x0018(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KRCW[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RK7P[0x14];                                    // 0x0018(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9SU2[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
