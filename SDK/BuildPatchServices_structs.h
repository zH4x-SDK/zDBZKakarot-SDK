...
struct FChunkInfoData
{
	...
	unsigned char                                      UnknownData_DGRV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OTIS[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FFileManifestData
{
	...
	unsigned char                                      UnknownData_4ZK6[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q4QI[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7809[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
