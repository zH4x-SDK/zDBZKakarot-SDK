...
struct FStructSerializerNumericTestStruct
{
	...
	unsigned char                                      UnknownData_EYPK[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q2PI[0x1];                                     // 0x0011(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZWZI[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerBooleanTestStruct
{
	...
	unsigned char                                      UnknownData_QTWS[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerArrayTestStruct
{
	...
	unsigned char                                      UnknownData_K16L[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStructSerializerBuiltinTestStruct
{
	...
	unsigned char                                      UnknownData_22CZ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0U3H[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
