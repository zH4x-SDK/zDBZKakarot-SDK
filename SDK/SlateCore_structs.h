...
struct FGeometry
{
	unsigned char                                      UnknownData_IEHU[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_2XB4[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	unsigned char                                      UnknownData_FQWC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QMB9[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ETVB[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_LF7N[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SYJA[0x58];                                    // 0x0018(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XWFB[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FN2I[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JNSQ[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XZOE[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FFontOutlineSettings
{
	...
	unsigned char                                      UnknownData_ZZ3H[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7K1X[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_ZXL8[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GIDZ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z1P4[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_HA40[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FFocusEvent
{
	unsigned char                                      UnknownData_KT6Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4DQT[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_S29H[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeFallbackFont
{
	...
	unsigned char                                      UnknownData_8TYA[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_89EF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_SETS[0x4];                                     // 0x06D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_B92N[0x6];                                     // 0x0092(0x0006) MISSED OFFSET (PADDING)
...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_T2DU[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_JZUB[0x7];                                     // 0x0A89(0x0007) MISSED OFFSET (PADDING)
...
struct FExpandableAreaStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_9SWI[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_SSJE[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
