...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_IHIS[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_Y1RA[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EEE4[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
