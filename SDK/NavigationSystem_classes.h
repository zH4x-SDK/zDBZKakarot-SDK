...
{
public:
	unsigned char                                      UnknownData_ZVTT[0x8];                                     // 0x0338(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7X06[0x3];                                     // 0x03B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FZKM[0x3];                                     // 0x03B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M0M6[0xD0];                                    // 0x03C0(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FSupportedAreaData>                  SupportedAreas;                                            // 0x0490(0x0010) (ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_RVU1[0x58];                                    // 0x04A0(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F28I[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N3GX[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IKG0[0x2F];                                    // 0x00A9(0x002F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CO32[0x3F];                                    // 0x0049(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ILXQ[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
// 0x03E8 (FullSize[0x0410] - InheritedSize[0x0028])
...
public:
	...
	unsigned char                                      UnknownData_S9CA : 1;                                      // 0x0040(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_DAEY[0x2];                                     // 0x0042(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YRYN[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8CGV[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_17UR[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZVHE[0x60];                                    // 0x0088(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TC7I[0xCC];                                    // 0x0108(0x00CC) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	Engine_EFNavigationSystemRunMode                   OperationMode;                                             // 0x01D4(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_H9UO[0x23B];                                   // 0x01D5(0x023B) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2HLG[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_C5QY[0x10];                                    // 0x0338(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7KF6[0x7];                                     // 0x0359(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FMKZ[0x4];                                     // 0x039C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      bShowDiffWithPreviousStep : 1;                             // 0x03B4(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_3BMM[0x2];                                     // 0x03B6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_11NK[0x3];                                     // 0x03B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8RXE[0x3];                                     // 0x03C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EHYQ[0x4];                                     // 0x03D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F1FK[0x30];                                    // 0x03F0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8F8U[0x8];                                     // 0x0568(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_TCJR[0x24];                                    // 0x0100(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_COJF[0x3];                                     // 0x0125(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_056O[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2HE0[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WEIL[0x3];                                     // 0x0169(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SF0P[0x3];                                     // 0x016D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H9G0[0x3F];                                    // 0x0199(0x003F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7VGG[0x8];                                     // 0x0568(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_SHUC[0x4];                                     // 0x0374(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VU5G[0x8];                                     // 0x0568(0x0008) Fix Super Size
	unsigned char                                      UnknownData_S32N[0x10];                                    // 0x0570(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BN82[0x13];                                    // 0x0145(0x0013) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X4WE[0x8];                                     // 0x0370(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_H2O8[0x7];                                     // 0x0341(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_806E[0x8];                                     // 0x0568(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_BU5Z[0x1];                                     // 0x04FB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9BFW[0x3];                                     // 0x0501(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9R2Y[0x2];                                     // 0x0562(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9PO1[0x2];                                     // 0x056E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_78E4[0x34];                                    // 0x057C(0x0034) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V3UI[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
