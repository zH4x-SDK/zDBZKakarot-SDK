...
public:
	...
	unsigned char                                      UnknownData_91KD[0x20];                                    // 0x0048(0x0020) MISSED OFFSET (PADDING)
...
// 0x0090 (FullSize[0x0448] - InheritedSize[0x03B8])
class AAIController : public AController
{
public:
	unsigned char                                      UnknownData_E8RQ[0x38];                                    // 0x03B8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bStopAILogicOnUnposses : 1;                                // 0x03F0(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      bLOSflag : 1;                                              // 0x03F0(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                   // 0x03F0(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bAllowStrafe : 1;                                          // 0x03F0(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bWantsPlayerState : 1;                                     // 0x03F0(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;                // 0x03F0(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2XXX[0x7];                                     // 0x03F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	class UClass*                                      DefaultNavigationFilterClass;                              // 0x0428(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                      // 0x0430(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LI82[0x8];                                     // 0x0440(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CLU2[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VYYU[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_E9MZ[0x10];                                    // 0x0118(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NMSC[0x80];                                    // 0x0130(0x0080) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_VURJ[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_0VCJ[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KH44[0x9C];                                    // 0x0094(0x009C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QF4L[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MLA2[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VVLY[0x48];                                    // 0x0040(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_F94T[0x54];                                    // 0x009C(0x0054) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GEVM[0xB0];                                    // 0x0088(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CS54[0x4];                                     // 0x014C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PT8Z[0x8];                                     // 0x0158(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0K9S[0x17];                                    // 0x0031(0x0017) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J38T[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_8OJ6[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EB3K[0x5];                                     // 0x009B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_233C[0x58];                                    // 0x00D8(0x0058) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AZN4[0x40];                                    // 0x00D0(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_S8HA[0x78];                                    // 0x0070(0x0078) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DMJ2[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3TPG[0x8];                                     // 0x0100(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DU1T[0x48];                                    // 0x0118(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9R1A[0x20];                                    // 0x0160(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UBTNode*>                             NodeInstances;                                             // 0x0180(0x0010) (ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_72VU[0x120];                                   // 0x0190(0x0120) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_UKKV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_CFGQ[0x20];                                    // 0x0110(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TBI6[0xB8];                                    // 0x0140(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KFQ7[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J5OQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_JN3D[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_21J0[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6AF2[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_N319[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CU41[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D1T6[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_LNRP[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CDGR : 7;                                      // 0x0060(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_VYU7[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_94L2[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5LKU[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_O6N7[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VH4K[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_90H0[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_FOO8[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_7N9O[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3GBV[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YCHB[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KAHR[0x3];                                     // 0x00B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MV75[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_JHBF[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G7VM[0x3];                                     // 0x00C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PEO0[0x3];                                     // 0x00CD(0x0003) MISSED OFFSET (PADDING)
...
public:
	float                                              ConeHalfAngle;                                             // 0x0068(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TN56[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBlackboardKeySelector                      ConeOrigin;                                                // 0x0070(0x0028) (Edit, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_XUWO[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QAM4[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IIO8[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SWCS[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5EIR[0x2];                                     // 0x0076(0x0002) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8WZS[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MU7M[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RRCZ[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PZQH[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RWWR[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_BYKM[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_FAOO[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
public:
	class AAIController*                               AIOwner;                                                   // 0x0070(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AActor*                                      ActorOwner;                                                // 0x0078(0x0008) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_VA0W[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bShowPropertyDetails : 1;                                  // 0x0098(0x0001) BIT_FIELD (Edit, DisableEditOnTemplate, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData_5F01[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_64AW[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_11X1[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2GJ3[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GLO4[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XCH5[0x2];                                     // 0x00AE(0x0002) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7S4I[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_N84Z[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_57VG[0x20];                                    // 0x0090(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7XDO[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T2XZ[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_990B[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FEQSParametrizedQueryExecutionRequest       EQSRequest;                                                // 0x00F8(0x0048) (Edit, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QUL3[0x10];                                    // 0x0140(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_2JB2[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
// 0x01A8 (FullSize[0x02A8] - InheritedSize[0x0100])
class UPathFollowingComponent : public UActorComponent
{
public:
	unsigned char                                      UnknownData_6J9P[0x38];                                    // 0x0100(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_042Q[0x8];                                     // 0x0140(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EXWC[0x158];                                   // 0x0150(0x0158) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SUC5[0x8];                                     // 0x02A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FV4V[0x24];                                    // 0x02C4(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VS6J : 4;                                      // 0x0070(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_YSDK[0x7F];                                    // 0x0071(0x007F) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_C7MK[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_V7Y5[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZBX1[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_T9GB[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZXDT[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_C5R1[0x7];                                     // 0x0149(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SKAX[0x7];                                     // 0x0191(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SO5V[0x7];                                     // 0x01A1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ELA6[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SPY8[0x4];                                     // 0x016C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZTYS[0x7];                                     // 0x0179(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NOQ8[0x7];                                     // 0x01E1(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BEO4[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8XLZ[0x24];                                    // 0x0034(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_30CP[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_O9IU[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_53X2[0x78];                                    // 0x0028(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MI2K[0x54];                                    // 0x00D0(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AREO[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_V8QJ[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H7NW[0x5];                                     // 0x004B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CWCR[0x1];                                     // 0x00E0(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RIYJ[0x3];                                     // 0x00E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5ZS1[0xF];                                     // 0x01A9(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bWorkOnFloatValues : 1;                                    // 0x01B8(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_A62C[0x7];                                     // 0x01B9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XHSQ[0x7];                                     // 0x01C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_IJSN[0x6];                                     // 0x0202(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YC91[0x6];                                     // 0x020A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_288Y[0x7];                                     // 0x01C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_K99X[0x8];                                     // 0x0568(0x0008) Fix Super Size
	unsigned char                                      UnknownData_JSWN[0x30];                                    // 0x0570(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2OCB[0x8];                                     // 0x0748(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_ODXH[0x3];                                     // 0x0781(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4S0H[0x3];                                     // 0x0785(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6PCY[0x7];                                     // 0x0789(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FNavAgentProperties                         NavAgentProperties;                                        // 0x0790(0x0030) (Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_DBQE[0x20];                                    // 0x07C0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_11XK[0x28];                                    // 0x02B0(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LU48[0x10];                                    // 0x0338(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VEO4[0x7];                                     // 0x0371(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_6W5Q[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ICJ9[0x30];                                    // 0x0050(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XK1A[0x17];                                    // 0x0081(0x0017) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AEUH[0x2F];                                    // 0x00B9(0x002F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NQ6F[0xF];                                     // 0x00A9(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	TEnumAsByte<AIModule_EPawnActionFailHandling>      ChildFailureHandlingMode;                                  // 0x00A8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HRQP[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3P34[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DQQZ[0xC];                                     // 0x009C(0x000C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NEKG[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_STKA[0xB];                                     // 0x0115(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
