...
public:
	...
	void STATIC_SendAIMessage(class APawn* Target);
	...
	void STATIC_GetCurrentPath(class AController* Controller);
	void STATIC_GetBlackboard(class AActor* Target);
...
public:
	...
	void STATIC_RunEQS(class AAIController* Controller);
};
...
{
public:
	unsigned char                                      UnknownData00[0x150];                                     // 0x0160(0x0150) MISSED OFFSET
...
public:
	float                                              ConeHalfAngle;                                            // 0x0068(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5C];                                      // 0x006C(0x005C) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x168];                                     // 0x0140(0x0168) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x90];                                      // 0x0750(0x0090) MISSED OFFSET
...
public:
	...
	void STATIC_SetLocalNavigationGridDensity();
	void STATIC_RemoveLocalNavigationGrid();
	void STATIC_FindLocalNavigationGridPath();
	void STATIC_AddLocalNavigationGridForPoints();
	void STATIC_AddLocalNavigationGridForPoint();
	void STATIC_AddLocalNavigationGridForCapsule();
	void STATIC_AddLocalNavigationGridForBox();
};
