...
struct FEventReply
{
	unsigned char                                      UnknownData_B3TA[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CBTM[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_QAQH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_RUDH[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_BQOW[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_IS9R[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_8RE9[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_3UH4[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
