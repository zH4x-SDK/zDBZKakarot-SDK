...
struct FDatasmithCameraFocusSettingsTemplate
{
	...
	unsigned char                                      UnknownData_AYKO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	unsigned char                                      UnknownData_TEV1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELJR[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DLFS[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YHJY[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FDatasmithImportBaseOptions
{
	...
	unsigned char                                      UnknownData_05LK[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UB8M[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FDatasmithMeshBuildSettingsTemplate
{
	...
	unsigned char                                      UnknownData_KSHG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
