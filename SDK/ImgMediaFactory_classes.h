...
public:
	...
	unsigned char                                      UnknownData_HD8P[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_516O[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
