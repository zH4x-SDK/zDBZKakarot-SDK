...
struct FSupportedAreaData
{
	...
	unsigned char                                      UnknownData_2SXQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavGraphNode
{
	...
	unsigned char                                      UnknownData_7Z50[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FNavigationFilterArea
{
	...
	unsigned char                                      UnknownData_WEMG[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FNavigationFilterFlags
{
	...
	unsigned char                                      UnknownData_PRW5[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_992X[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
