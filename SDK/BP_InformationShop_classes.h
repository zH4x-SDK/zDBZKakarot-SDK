...
// BlueprintGeneratedClass BP_InformationShop.BP_InformationShop_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_InformationShop.BP_InformationShop_C");
		return ptr;
	}
