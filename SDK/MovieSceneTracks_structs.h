...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_Y9EM[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMovieSceneActorReferenceKey>        KeyValues;                                                 // 0x0030(0x0010) (ZeroConstructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_ILZP[0x60];                                    // 0x0040(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionData
{
	...
	unsigned char                                      UnknownData_UL19[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	unsigned char                                      UnknownData_GM3M[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELQU[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7GZB[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_X7HN[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_CSQW[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	unsigned char                                      UnknownData_HVPX[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WUYO[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneStringChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_8VUM[0x67];                                    // 0x0039(0x0067) MISSED OFFSET (PADDING)
...
struct FMovieScene3DAttachSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_MJ0B[0x2];                                     // 0x004E(0x0002) MISSED OFFSET (PADDING)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_96ED[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EQGV[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_HVLW[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DScaleKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_6FJN[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DRotationKeyStruct : public FMovieSceneKeyStruct
{
	...
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_9CET[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DLocationKeyStruct : public FMovieSceneKeyStruct
{
	struct FVector                                     Location;                                                  // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I36V[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformTemplateData
{
	...
	unsigned char                                      UnknownData_SZN9[0x3];                                     // 0x0641(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1G6T[0x7];                                     // 0x0649(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneAudioSectionTemplateData
{
	...
	unsigned char                                      UnknownData_YVPI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1GK1[0x3];                                     // 0x015D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneCameraShakeSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	unsigned char                                      UnknownData_2V4R[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	struct FFrameNumber                                SectionStartTime;                                          // 0x0040(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_JATW[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraCutSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_IL5Z[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0W5[0xF];                                     // 0x0071(0x000F) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_0W4X[0x1C];                                    // 0x001C(0x001C) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_NX4I[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventTemplateBase : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_I92U[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_S7AP[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneLevelVisibilitySectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_LUS1[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneComponentMaterialSectionTemplate : public FMovieSceneParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_QAHC[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_LAZ9[0x3];                                     // 0x02CD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_OILW[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_HZLR[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneVectorKeyStructBase : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_TEKZ[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BY91[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorKeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	unsigned char                                      UnknownData_N0JD[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
