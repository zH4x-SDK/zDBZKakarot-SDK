...
public:
	...
	void STATIC_RemoveGameplayTag(struct FGameplayTagContainer* TagContainer);
	...
	void STATIC_AppendGameplayTagContainers(struct FGameplayTagContainer* InOutTagContainer);
	void STATIC_AddGameplayTag(struct FGameplayTagContainer* TagContainer);
};
