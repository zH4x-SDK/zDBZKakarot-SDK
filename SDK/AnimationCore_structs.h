...
struct FAxis
{
	...
	unsigned char                                      UnknownData_WGFL[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDescriptor
{
	...
	unsigned char                                      UnknownData_EZQF[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (PADDING)
...
struct FConstraintData
{
	...
	unsigned char                                      UnknownData_QGEA[0xB];                                     // 0x0015(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CKSA[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FFilterOptionPerAxis                        AxesFilterOption;                                          // 0x0008(0x0003) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_T8O4[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (PADDING)
...
struct FAimConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_NX6M[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTransformConstraintDescription : public FConstraintDescriptionEx
{
	...
	unsigned char                                      UnknownData_CZMZ[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FTransformConstraint
{
	...
	unsigned char                                      UnknownData_6VWC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BEJQ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintOffset
{
	...
	unsigned char                                      UnknownData_7WVT[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q1DT[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OPPV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
